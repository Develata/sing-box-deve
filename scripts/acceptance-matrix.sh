...
echo "   sudo ${SCRIPT} install --provider vps --profile full --engine xray --protocols vless-reality,vless-ws --argo temp --yes"
...
echo "4) Serv00/SAP require credentials and should be executed with corresponding env templates from examples/."
