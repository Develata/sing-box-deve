...
Usage:
  ...
  sing-box-deve.sh cfg preview <rotate-id|argo|ip-pref|cdn-host|domain-split|tls|profile|protocol-add|protocol-remove|rebuild> ...
  sing-box-deve.sh cfg apply <rotate-id|argo|ip-pref|cdn-host|domain-split|tls|profile|protocol-add|protocol-remove|rebuild> ...
