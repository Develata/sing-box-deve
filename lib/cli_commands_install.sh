...
apply_config() {
  ...
  export WEB_FRONT_MODE="${web_front_mode:-${WEB_FRONT_MODE:-auto}}"
  export HY2_OBFS_MODE="${hy2_obfs_mode:-${HY2_OBFS_MODE:-off}}"
  export HY2_OBFS_PASSWORD="${hy2_obfs_password:-${HY2_OBFS_PASSWORD:-}}"
