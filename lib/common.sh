...
source "${PROJECT_ROOT}/lib/common_ownership.sh"
...
source "${PROJECT_ROOT}/lib/common_release.sh"
source "${PROJECT_ROOT}/lib/common_context.sh"
source "${PROJECT_ROOT}/lib/common_doctor.sh"
